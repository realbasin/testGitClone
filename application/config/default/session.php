 ...
 * 
 */
//return new Xs_Session_Memcache(array('path' => 'tcp://127.0.0.1:11211?persistent=0&timeout=3'));
/**
 * Memcached托管
 * 用法和Memcache一样，只是前面不带tcp://
 */
return new Xs_Session_Memcached(array('path' => '127.0.0.1:11211?persistent=0&timeout=3'));
/**
 * Redis托管
 ...
 * database：0 整数，数据库号
 */
//return new Xs_Session_Redis(array('path' => 'tcp://127.0.0.1:6379?timeout=3&persistent=0'));
/**
 * Mongodb托管
 */
/* 
return new Xs_Session_Mongodb(array(
    ...
    'persistentId' => 'MongoSession', // 持久连接id
    // 是否支持 replicaSet
    'replicaSet' => false,
	)
);
 ...
 */
/* 
return new I_Session_Mysql(array(
