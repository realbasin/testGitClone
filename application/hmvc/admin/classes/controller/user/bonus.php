...
class  controller_user_bonus extends controller_sysBase {
	...
	public function do_type_add() {
        if (chksubmit()) {
            ...
            $insertData = array(
                ...
                'start_time' => to_timespan(\Core::post('start_time')),
                'end_time' => to_timespan($end_time),
                'use_start_time' => to_timespan(\Core::post('use_start_time')),
                'use_end_time_type' => \Core::post('use_end_time_type'),
                'use_end_time' => to_timespan($use_end_time),
    ...
    public function do_type_edit() {
        ...
        $bonusType['start_time'] = !empty($bonusType['start_time']) ? to_date($bonusType['start_time']) : to_date($bonusType['create_time']);
        $bonusType['use_start_time'] = !empty($bonusType['use_start_time']) ? to_date($bonusType['use_start_time']) : to_date($bonusType['create_time']);
