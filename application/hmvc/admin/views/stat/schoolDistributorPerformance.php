...
function list_day(id){
	var url= '<?php echo adminUrl('stat_distributor','schoolDistributorPerformance_day');?>'+'&id='+id;
    window.location.href =url;
}

function list_month(id){
	var url= '<?php echo adminUrl('stat_distributor','schoolDistributorPerformance_month');?>'+'&id='+id;
    window.location.href =url;
}

function list_sub(id){
	var url= '<?php echo adminUrl('stat_distributor','schoolDistributorPerformance_subordinate');?>'+'&id='+id;
    window.location.href =url;
}
