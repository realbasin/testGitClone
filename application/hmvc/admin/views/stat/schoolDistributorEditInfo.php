...
<div class="page">
  <form method="post" id="form1" name="form1">
    ...
    <dl class="row">
        ...
        <dd class="opt">
          <input type="text" readonly="readonly" name="user_name" id="user_name" maxlength="20" class="input-txt" value="<?php echo $user_name;?>">
          <p class="notic">用户名称不能编辑</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
        ...
        <dd class="opt">
          <input type="text" class="input-txt" name="email" id="email" value="<?php echo $email;?>" ignore="ignore" datatype="e"  sucmsg=" "  >
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" class="input-txt" name="mobile" id="mobile" value="<?php echo $mobile;?>" ignore="ignore" datatype="m" sucmsg=" " ajaxurl="<?php echo adminUrl('stat_distributor','schoolDistributor_mobile_Verify',array('user_id'=>$id));?>" errormsg="手机号码错误或系统中存在相同的手机号码">
          <span class="Validform_checktip"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="password" class="input-txt" name="user_pwd" id="user_pwd" ignore="ignore"   datatype="*6-16" sucmsg=" "  >
          <span class="Validform_checktip"></span>
          <p class="notic">密码留空表示不更改密码</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
        ...
        <dd class="opt">
          <input type="password" class="input-txt" name="user_pwd1" id="user_pwd1" ignore="ignore"  recheck="user_pwd" datatype="*6-16"  sucmsg=" "  >
          <span class="Validform_checktip"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="checkbox" class="js-switch blue" name="is_effect" id="is_effect" <?php echo $is_effect?'checked':'';?> />
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select id="admin_id" name="admin_id" value="<?php echo $admin_id;?>">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" class="input-txt" value="<?php echo $real_name;?>" maxlength="20" name="real_name" id="real_name" datatype="*" sucmsg=" "  >
          <span class="Validform_checktip"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" class="input-txt" maxlength="18" value="<?php echo $idno;?>" name="idno" id="idno" datatype="/(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/" sucmsg=" "  ajaxurl="<?php echo adminUrl('stat_distributor','schoolDistributor_idno_Verify',array('user_id'=>$id));?>" errormsg="身份证号码错误或系统中存在相同的身份证号码">
          <span class="Validform_checktip"></span>
...
$('#admin_id').val('<?php echo $admin_id;?>');
</script>
</body>
</html>