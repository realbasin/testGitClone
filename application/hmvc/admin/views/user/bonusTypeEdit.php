    ...
    <form method="post" id="form1" name="form1">
        ...
        <div class="form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" class="input-txt" name="end_time" id="end_time" value="<?php if(!empty($bonusType)) echo date($bonusType['end_time']);?>">
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <input type="text" class="input-txt" name="use_end_time" id="use_end_time" value="<?php if(!empty($bonusType)) echo date($bonusType['use_end_time']);?>" />
