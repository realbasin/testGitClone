...
<div class="page">
    <div class="form-default">
      ...
      <dd class="opt">
        ...
        <a href="<?php echo adminUrl('common','excelExport');?>&page=<?php echo $k;?>&datakey=<?php echo $dataKey?>&url=<?php echo urlencode($murl);?>" class="input-btn mr10 mb10">下载Excel分页<?php echo $k;?> (<?php echo $v;?>条)</a>
        <?php }?>
      </dd>
    </dl>
	</div>
