...
<div class="location">
  ...
  <i class="arrow"></i>
  <span><?php echo \Core::L('edit');?></span>
...
<div class="page">
  <form method="post" id="form1" name="form1">
    ...
    <dl class="row">
        ...
        <dd class="opt">
          <input type="text" name="admin_name" id="admin_name" class="input-txt" value="<?php if(isset($admin_name)) echo $admin_name;?>" datatype="/^[a-zA-Z]\w{4,19}$/" nullmsg="<?php echo \Core::L("admin_name_null");?>" errormsg="<?php echo \Core::L("admin_name_error");?>" sucmsg=" "  >
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="password" name="admin_password" id="admin_password" class="input-txt" value="" ignore="ignore" datatype="/^[a-zA-Z]\w{5,19}$/" nullmsg="<?php echo \Core::L("admin_password_null");?>" errormsg="<?php echo \Core::L("admin_password_error");?>" sucmsg=" "  >
          <span class="Validform_checktip"></span>
          <p class="notic"><?php echo \Core::L('admin_password_edit_notice');?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
        ...
        <dd class="opt">
          <input type="password" name="admin_password_confirm" id="admin_password_confirm" class="input-txt" value="" ignore="ignore" recheck="admin_password" datatype="*" nullmsg="<?php echo \Core::L("admin_password_confirm_null");?>" errormsg="<?php echo \Core::L("admin_password_confirm_error");?>" sucmsg=" "  >
          <span class="Validform_checktip"></span>
          <p class="notic"><?php echo \Core::L('admin_password_edit_notice');?></p>
        </dd>
      </dl>
...
$('#syshelp').on("click",function(){
	var d = dialog({
        content: "<?php echo \Core::L('admin_edit_help');?>",
        quickClose: true
        });
       d.show(this);
});
 ...
 $(function () {
	 $("#form1").initValidform();
	 $('#admin_gid').val('<?php if(isset($admin_gid)) echo $admin_gid;?>');	
	});
</script>
</body>
</html>