...
<div class="location">
  ...
  <i class="arrow"></i>
  <span><?php echo \Core::L('login_sms_setting');?></span>
</div>
...
<div class="page">
  ...
  <form method="post" id="form1" name="form1">
    ...
    <div class="form-default">
    	<dl class="row">
        <dt class="tit">
          <label><?php echo \Core::L('login_sms');?></label>
        </dt>
        <dd class="opt">
          <input type="checkbox" class="js-switch blue" name="login_sms" id="login_sms" value="oss" <?php if(C('login_sms')) echo 'checked';?> />
          <p class="notic"><?php echo \Core::L('login_sms_notice');?></p>
        </dd>
     </dl>
      </div>
...
<script type="text/javascript">
	var help_content="<?php echo \Core::L('login_sms_help');?>";
	function help(ctrl){
		var d = dialog({
