...
<div class="location">
  ...
  <i class="arrow"></i>
  <span><?php echo \Core::L('login_wechat_setting');?></span>
</div>
...
<div class="page">
  ...
  <form method="post" id="form1" name="form1">
    ...
    <div class="form-default">
    	<dl class="row">
        <dt class="tit">
          <label><?php echo \Core::L('login_wechat');?></label>
        </dt>
        <dd class="opt">
          <input type="checkbox" class="js-switch blue" name="login_wechat" id="login_wechat" value="oss" <?php if(C('login_wechat')) echo 'checked';?> />
...
<script type="text/javascript">
	var help_content="<?php echo \Core::L('login_wechat_help');?>";
	function help(ctrl){
		var d = dialog({
