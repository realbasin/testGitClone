...
<div class="location">
  ...
  <i class="arrow"></i>
  <span><?php echo \Core::L('edit,permission_setting');?></span>
...
<div class="page">
  <form method="post" id="form1" name="form1">
    ...
    <dl class="row">
        ...
        <dd class="opt">
          <input type="text" name="gname" id="gname" class="input-txt" value="<?php if(isset($gname)) echo $gname;?>" datatype="*" nullmsg="<?php echo \Core::L("auth_name_null");?>" sucmsg=" "  >
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" name="info" id="info" class="input-txt" value="<?php if(isset($info))  echo $info;?>" datatype="*" nullmsg="<?php echo \Core::L("auth_info_null");?>" sucmsg=" "  >
          	<span class="Validform_checktip"></span>
        		...
        		<div class="account-container">
        			<h4>
        			 ...
        			 <ul class="account-container-list">
        			 	...
        			 	<li>
        			 		<input class="checkbox" type="checkbox" value="<?php echo $ls['link']?>" name="permission[]" <?php if(in_array($ls['link'],$permission)) echo "checked";?>><?php echo $ls['text']?>
        			 	</li>
        			 	<?php }?>
        			 </ul>
        		</div>
