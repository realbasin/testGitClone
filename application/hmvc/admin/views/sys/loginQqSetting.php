...
<div class="location">
  ...
  <i class="arrow"></i>
  <span><?php echo \Core::L('login_qq_setting');?></span>
</div>
...
<div class="page">
  ...
  <form method="post" id="form1" name="form1">
    ...
    <div class="form-default">
    	<dl class="row">
        <dt class="tit">
          <label><?php echo \Core::L('login_qq');?></label>
        </dt>
        <dd class="opt">
          <input type="checkbox" class="js-switch blue" name="login_qq" id="login_qq" value="oss" <?php if(C('login_qq')) echo 'checked';?> />
          <p class="notic"><?php echo \Core::L('login_qq_notice');?></p>
        </dd>
      </dl>
    <dl class="row">
        <dt class="tit">
...
<script type="text/javascript">
	var help_content="<?php echo \Core::L('login_qq_help');?>";
	function help(ctrl){
		var d = dialog({
