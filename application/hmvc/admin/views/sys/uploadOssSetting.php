...
<div class="location">
  ...
  <i class="arrow"></i>
  <span><?php echo \Core::L('upload_oss_setting');?></span>
</div>
...
<div class="page">
  ...
  <form method="post" id="form1" name="form1">
    ...
    <div class="form-default">
        ...
        <dd class="opt">
          <input type="checkbox" class="js-switch blue" name="upload_driver" id="upload_driver" value="oss" <?php if(C('upload_driver')=='oss') echo 'checked';?> />
          <p class="notic"><?php echo \Core::L('upload_driver_oss');?></p>
        </dd>
      </dl>
    <dl class="row">
        <dt class="tit">
          <label><em>*</em><?php echo \Core::L('upload_oss_bucket');?></label>
        </dt>
        <dd class="opt">
          <input type="text" name="bucket" id="bucket" class="input-txt" value="<?php if(isset($bucket)) echo $bucket;?>" datatype="*"  sucmsg=" ">
          	<span class="Validform_checktip"></span>
          <p class="notic"><?php echo \Core::L('upload_oss_bucket_notice');?></p>
        </dd>
      </dl>
    <dl class="row">
        <dt class="tit">
          <label><em>*</em><?php echo \Core::L('upload_oss_accesskey');?></label>
        </dt>
        <dd class="opt">
          <input type="text" name="accesskey" id="accesskey" class="input-txt" value="<?php if(isset($accesskey)) echo $accesskey;?>" datatype="*"  sucmsg=" ">
          	<span class="Validform_checktip"></span>
          <p class="notic"><?php echo \Core::L('upload_oss_accesskey_notice');?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label><em>*</em><?php echo \Core::L('upload_oss_secretkey');?></label>
        </dt>
        <dd class="opt">
          <input type="text" name="secretkey" id="secretkey" class="input-txt" value="<?php if(isset($secretkey)) echo $secretkey;?>" datatype="*"  sucmsg=" ">
          	<span class="Validform_checktip"></span>
          <p class="notic"><?php echo \Core::L('upload_oss_secretkey_notice');?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label><em>*</em><?php echo \Core::L('upload_oss_endpoint');?></label>
        </dt>
        <dd class="opt">
          <input type="text" name="endpoint" id="endpoint" class="input-txt" value="<?php if(isset($endpoint)) echo $endpoint;?>" datatype="*"  sucmsg=" ">
          	<span class="Validform_checktip"></span>
          <p class="notic"><?php echo \Core::L('upload_oss_endpoint_notice');?></p>
        </dd>
      </dl>
      </div>
...
<script type="text/javascript">
	var help_content="<?php echo \Core::L('upload_setting_oss_help');?>";
	function help(ctrl){
		var d = dialog({
