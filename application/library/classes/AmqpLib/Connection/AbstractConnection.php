...
use AmqpLib\Channel\AbstractChannel;
use AmqpLib\Exception\AMQPProtocolConnectionException;
use AmqpLib\Exception\AMQPRuntimeException;
use AmqpLib\Exception\AMQPTimeoutException;
use AmqpLib\Wire\AMQPReader;
use AmqpLib\Wire\AMQPTable;
use AmqpLib\Wire\AMQPWriter;
use AmqpLib\Wire\IO\AbstractIO;
use AmqpLib\Wire\IO\SocketIO;
...
class AbstractConnection extends AbstractChannel
{
    ...
    /** @var \AmqpLib\Wire\IO\AbstractIO */
    protected $io;
     ...
     * @return array
     * @throws \Exception
     * @throws \AmqpLib\Exception\AMQPTimeoutException
     * @throws \AmqpLib\Exception\AMQPRuntimeException
     */
     ...
     * @throws \AmqpLib\Exception\AMQPProtocolConnectionException
     */
