...
use AmqpLib\Exception\AMQPBasicCancelException;
...
class AMQPChannel extends AbstractChannel
{
    ...
    /**
     * @param \AmqpLib\Connection\AbstractConnection $connection
    ...
    /**
     * @param AMQPReader $reader
     * @throws \AmqpLib\Exception\AMQPProtocolChannelException
     */
    ...
    /**
     * @param AMQPReader $reader
     * @throws \AmqpLib\Exception\AMQPBasicCancelException
     */
    ...
    protected function basic_deliver($reader, $message)
    {
        ...
        if (isset($this->callbacks[$consumer_tag])) {
            ...
            $this->callbacks[$consumer_tag]($message);
        }
    }
