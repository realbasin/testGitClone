...
class HttpUtils
{
    ...
    public static function request()
    {
        ...
        if ($req === false) {
            ...
            if ($env == 'production') {
                $_config['open_api_url'] = $_config['open_api_url_www'];
                $_config['project_id'] = $_config['project_id_www'];
                $_config['project_secret'] = $_config['project_secret_www'];
            } else {
                $_config['open_api_url'] = $_config['open_api_url_test'];
                $_config['project_id'] = $_config['project_id_test'];
                $_config['project_secret'] = $_config['project_secret_test'];
            }
    ...
    public function buildSignHttpRequest($url, array $data, $isJson)
    {
        ...
        $this->outHeader = true;
        //远程获取数据
        $this->sendHttpRequestPost($url, $data, $header);
