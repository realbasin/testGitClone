...
class JavaComm
{
    ...
    public function eventSignPDF(array $signFile, array $signPos, $signType, $certId, $sealData = '')
    {
        ...
        $keysArr = array(
            'signPos' => array(
                ...
                'width' => isset($signPos['width']) ? $signPos['width'] : ''
            ),
            'signType' => $signType,
            'certId' => $certId,
            'sealData' => $sealData,
     ...
     * @return array|mixed
     */
    public function userSignPDF($accountId, $signFile, $signPos, $signType, $sealData, $mobile = '', $code = '')
    {
        if (!empty($signPos['key'])) {
            $posType = 1;
        } else {
     ...
     * @throws Exception
     */
    public function userSignPDFStream($accountId, $signFile, $signPos, $signType, $sealData, $mobile = '', $code = '')
    {
        if (!empty($signPos['key'])) {
            $posType = 1;
        } else {
